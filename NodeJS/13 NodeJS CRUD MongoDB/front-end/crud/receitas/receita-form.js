Vue.component('formulario-receita', {
            ...
            <v-container>
                <v-row>
                    <v-col cols="12">
                        ...
                        <p class="view-label" v-show="this.controlador.itemSelecionado._id != ''">ID:</p>
                        <p class="view-data" v-show="this.controlador.itemSelecionado._id != ''">{{controlador.itemSelecionado._id}}</p>
    ...
    methods: {
        prepara: function() {
            this.errorMessage = "";
            this.titulo = (this.controlador.itemSelecionado._id === "") ? "Nova receita" : "Edita Receita";
        },
